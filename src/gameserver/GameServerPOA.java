        ...
        implements GameServerOperations, org.omg.CORBA.portable.InvokeHandler
{
    ...
    {
        return GameServerHelper.narrow(_this_object());
    }

    public GameServer _this(org.omg.CORBA.ORB orb)
    {
        return GameServerHelper.narrow(_this_object(orb));
    }
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_playerSignIn(
        ...
        String _arg_result = playerSignIn(arg0_in, arg1_in, arg2_in);
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_playerSignOut(
        ...
        String _arg_result = playerSignOut(arg0_in, arg1_in);
